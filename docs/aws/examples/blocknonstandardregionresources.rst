...
The following are examples of LZ Watch Dog policies which detect the region
...
of the common AWS services but you may add your desired services if supported by LZ Watch Dog.
...
For the notify action to work you will need to have installed and configured the LZ Watch Dog
c7n-mailer tool.
