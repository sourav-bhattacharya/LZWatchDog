...
Note that for email delivery to work with the ``notify`` action, the LZ Watch Dog mailer tool must be installed, configured, and running.  See https://github.com/cloud-custodian/cloud-custodian/tree/master/tools/c7n_mailer for docs.
