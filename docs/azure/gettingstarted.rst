...
Install LZ Watch Dog and Azure Plugin
----------------------------------------

LZ Watch Dog is a Python application and supports Python 2 and 3 on Linux and Windows.
...
You can also upload LZ Watch Dog logs to App Insights logs::
