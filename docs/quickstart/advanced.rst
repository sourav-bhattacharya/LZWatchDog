...
By default LZ Watch Dog determines the region to run against in the following
order:
...
LZ Watch Dog can skip policies that are included in a policy file when running if
